...
function EditActionButtons({onSaveEdit, onCancelEdit}: EditActionButtonsProps) {
  return (
    <div className="flex items-center gap-2 mt-2">
      <Button
        onClick={onSaveEdit}
        className={"bg-surface-dark-green hover:bg-surface-light-green"}
        size={"sm"}
      >
        Save
      </Button>
      <Button
        ...
        className={"bg-surface-black hover:bg-surface-darkest"}
        size={"sm"}
      >
        Cancel
      </Button>
...
export function ProfileInfoCard({
  ...
  return (
    <Card color="transparent" shadow={false}>
      ...
      >
        <Typography variant="h5" className="text-surface-black">
          Profile Information
        </Typography>
        {isEditable && !isInEditMode && (
          <Tooltip content="Edit Profile">
            <PencilIcon
              ...
              className="h-4 w-4 cursor-pointer text-surface-dark-green hover:text-surface-light-green"
            />
          </Tooltip>
        )}
      </CardHeader>
      <CardBody className="p-0">
        ...
        />
        <hr className="my-2 border-white text-black"/>
