    ...
    <section className="m-8 flex gap-4">
      <div className="w-full lg:w-3/5 mt-24">
        <div className="text-center">
          ...
          <Typography variant="paragraph" color="surface-black" className="text-lg font-normal ">Enter your new password</Typography>
        </div>
        <div className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          <div className="mb-1 flex flex-col gap-6">
            ...
            <Input
              ...
              type="password"
              name="password"
              className=" !border-surface-black focus:!border-surface-light-green"
              placeholder='********'
              labelProps={{
          ...
          <Button className="mt-6 bg-surface-dark-green hover:bg-surface-light-green" fullWidth onClick={handleClick}>
            Confirm
          </Button>
