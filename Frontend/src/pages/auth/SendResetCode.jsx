...
const SendResetCode = () => {
  ...
  return (
    <section className="p-8 flex gap-4 text-surface-black">
      <div className="w-full lg:w-3/5 mt-24">
        <div className="text-center">
          <Typography variant="h2" className="font-bold mb-4">Reset Your Password</Typography>
          <Typography variant="paragraph" color="blue-gray" className="text-lg font-normal text-surface-black">Enter your email</Typography>
        </div>
        <div className="mt-8 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2">
          ...
          <Button className="mt-6 bg-surface-dark-green hover:bg-surface-light-green" fullWidth onClick={handleSendCode}>
