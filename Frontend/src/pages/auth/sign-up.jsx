...
export function SignUp() {
  ...
  return (
    <section className="p-8 flex text-surfac-black">
      ...
      <div className="w-full lg:w-3/5 flex flex-col items-center justify-center">
        <div className="text-center">
          ...
          <Typography variant="paragraph" color="blue-gray" className="text-lg font-normal text-surface-black">Enter your email, username, name and password to register.</Typography>
        </div>
        <form className="mt-2 mb-2 mx-auto w-80 max-w-screen-lg lg:w-1/2" onSubmit={handleSignup}>
          <div className="mb-1 flex flex-col gap-6">
            <Typography variant="small" color="blue-gray" className="-mb-3 font-medium text-surface-black">
              Your email
            </Typography>
            <Input
              size="lg"
          ...
          <Button className="mt-6 bg-surface-dark-green hover:bg-surface-light-green" fullWidth type="submit">
            Register Now
          </Button>
          <Typography variant="paragraph" className="text-center text-surface-black font-medium mt-4">
            Already have an account?
            <Link to="/auth/sign-in" className="text-surface-dark-green ml-1 hover:text-surface-light-green">Sign in</Link>
          </Typography>
        </form>
      </div>
    </section>
